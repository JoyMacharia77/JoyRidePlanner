...
Travel Destinations || JOYRIDE PLANNER
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <form action="/save-destinations" method="POST" enctype="multipart/form-data">
<form>
{{csrf_field() }}
    ...
    <option value="Asia">Asia</option>
          ...
          <div class="form-group">
            ...
            <input type="text" name="place" class="form-control" id="recipient-name"></textarea>
          </div>

          <div class="form-group">
            <label for="message-text" class="col-form-label">Estimated Price:</label>
            <input type="text" name="estimatedP" class="form-control" id="recipient-name"></textarea>
          </div>
...
@foreach ($destinations as $data)
    ...
    <tr>
        ...
        <td>{{$data->currency}}</td>
        <td>{{$data->place}}</td>
        <td>{{$data->estimatedP}}</td>
        <td>{{$data->category}}</td>
        <td>{{$data->description}}</td>
        <td><img style="width:100%"src="/storage/uploads/{{$data->picture}}"></td>
