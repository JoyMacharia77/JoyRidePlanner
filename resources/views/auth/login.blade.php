            ...
            <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Email addess..." required autocomplete="email" autofocus>
