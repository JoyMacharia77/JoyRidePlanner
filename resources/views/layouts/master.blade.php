...
<body class="">
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
        <img src="{{ url('/images/logo.png') }}" alt="Image" height="90px" width="170px" />
        <a href="/admin" class="simple-text logo-normal">
          JOYRIDE PLANNER || ADMIN
        </a>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="{{'providers' ==request()->path() ? 'active' : '' }}">
            <a href="./providers">
              ...
              <p>Register Service Providers</p>
            </a>
          </li>
          <li class="{{'role-register' ==request()->path() ? 'active' : '' }}">
            <a href="/individualadmin_view">
              <i class="now-ui-icons users_single-02"></i>
              <p>Individual Services</p>
            </a>
          </li>
          <li class="{{'role-register' ==request()->path() ? 'active' : '' }}">
            <a href="/groupadmin_view">
              <i class="now-ui-icons users_single-02"></i>
              <p>Group Services</p>
            </a>
          </li>
          <li class="{{'role-register' ==request()->path() ? 'active' : '' }}">
            <a href="/accommodationadmin_view">
              <i class="now-ui-icons users_single-02"></i>
              <p>Accommodation Services</p>
            </a>
          </li>
          <li class="{{'role-register' ==request()->path() ? 'active' : '' }}">
            <a href="/diningadmin_view">
              <i class="now-ui-icons users_single-02"></i>
              <p>Dining Services</p>
            </a>
          </li>
          <li class="{{'destinations' ==request()->path() ? 'active' : '' }}">
            <a href="/destinations">
