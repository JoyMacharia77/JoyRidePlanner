        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div style="text-align:right; margin:5px; color:white;">
                    <button class="btn btn-primary"><a href="{{route('groupsp.create')}}" style="color:white;">ADD SERVICE</a></button>
                </div>
                <div align="right">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="myTable" style="color:white;">
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('/groupsps/' . $row['image'])}}" width="100px;" height="100px;" alt="image"></td>
                                <td><a href="{{action('GroupspController@edit', $row['id'])}}" class="btn btn-warning">Edit</a></td>
                                <td>
                                    <form method="post" class="delete_form" action="{{action('GroupspController@destroy',$row['id'])}}">
                                        {{csrf_field()}}
