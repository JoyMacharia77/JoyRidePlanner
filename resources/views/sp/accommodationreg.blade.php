...
<head>
    ...
    <style>
        ...
        body {
            ...
            height: 100vh;
            /*margin: 0;*/
            background-image: url('storage/white7.jpg');
...
<body>
    ...
    <div class="container">
        <div>
            ...
            <h2>ACCOMMODATION-BASED SERVICE REGISTRATION</h2>
        </div><br>

        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#reg"><b> SERVICE</b></a></li>
            <li><a data-toggle="tab" href="#bookingdetails"><b>BOOKING DETAILS</b></a></li>
            <li><a data-toggle="tab" href="#bookings"><b>VIEW BOOKINGS</b></a></li>
        ...
        <div class="tab-content">
            ...
            <div id="bookingdetails" class="tab-pane fade">
                <h3>ENTER BOOKING DETAILS</h3>
                <p>FORM</p>
            </div>
            <div id="bookings" class="tab-pane fade">
                <h3>TRAVELLER BOOKINGS</h3>
                <p>view if booked,default-No booking</p>
            </div>
