    ...
    <style>
        ...
        body {
           ...
           /* color:seashell;*/
            ...
            height: 100vh;
            /*margin: 0;*/
            background-image: url('storage/dining1.jpg');
...
<body>
    ...
    <div class="container">
        <div>
            ...
            <h2>DINING SERVICE REGISTRATION</h2>
        </div><br>

        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#reg"><b>REGISTER SERVICE</b></a></li>
            <li><a data-toggle="tab" href="#dishes"><b>POPULAR DISHES</b></a></li>
        ...
        <div class="tab-content">
            ...
            <div id="dishes" class="tab-pane fade">
                ...
                <p>view,edit,delete(Upload via Form)</p>
            </div>
