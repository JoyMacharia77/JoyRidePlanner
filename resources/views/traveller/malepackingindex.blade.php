...
<body>
    <div class="container">
        <div style="text-align:right; margin:40px; color:white;">
            <button class="btn btn-primary"><a href="{{route('malepackinglist.create')}}" style="color:white;">ADD NEW ITEMS</a></button>
        </div>

        <div class="row">
            <div class="col-md-12">
                <br />
                <h1 style="text-align:center;">MY PACKING LIST</h1>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" class="delete_form" action="{{action('MalepackinglistController@destroy',$item['id'])}}">
                                        {{csrf_field()}}
                                        <input type="hidden" name="_method" value="DELETE" />
                                        <button type="submit" class="btn btn-danger" style="border-radius: 50%;">X</button>
                                    </form>
