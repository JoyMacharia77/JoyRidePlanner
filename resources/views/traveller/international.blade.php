...
<head>
  ...
  <title>Joyride Planner || International Travel  </title>
...
<li class="nav-item">
  ...
  <!-- Page Content -->
  <div class="container">
  <h3 class="text-uppercase text-white font-weight-bold">Lets Plan Your International Adventure</h3>
<div class="row">
  ...
  <div class="col-lg-3">
   ...
   <br><br><br>
    <div class="list-group">
      ...
      <a href="/all" class="list-group-item">Local Travel</a>
      <a href="/Longd" class="list-group-item">Long Distance Travel</a>
      <a href="/international" class="list-group-item">International Travel</a>
    </div>
    <br>
    <br>
    <br>
...
<form action="/Longd" method="get">
<div class="input-group">

<input type="int" name="Dsearch" class="input-control"/>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <a href="/info/{{$data->id}}"><img class="card-img-top" src="/storage/uploads/{{$data->picture}}" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">{{$data->place}}</a>
                </h4>
                <h5>Estimated price: {{$data->currency}} {{$data->estimatedP}}</h5>
